...
public class PessoaController {
    ...
    public ResponseEntity<List<Pessoa>> criarPessoas(@Valid @RequestBody List<PessoaCreateDTO> pessoas) {
        List<Pessoa> novasPessoas = pessoaService.cadastrarPessoas(pessoas);
        return ResponseEntity.status(201).body(novasPessoas);
    }
    ...
    public ResponseEntity<Page<Pessoa>> listarPessoas(
            ...
            @RequestParam(defaultValue = "10") @Min(1) @Max(150) int size) {
